...
#'
#' @keywords internal
bootstrap_group_scores_cpp <- function(ref_sp1, ref_sp2, selected_idx, n_bootstrap, seed) {
    .Call(`_coexpr_bootstrap_group_scores_cpp`, ref_sp1, ref_sp2, selected_idx, n_bootstrap, seed)
}
